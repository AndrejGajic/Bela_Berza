...
describe('LogovanjeKorisnikaEmail_uspesno', function() {
  this.timeout(30000)
  let driver
  let vars
  ...
  it('LogovanjeKorisnikaEmail_uspesno', async function() {
    ...
    await driver.findElement(By.id("nameInputField")).sendKeys("petarpan@pmail.com")
