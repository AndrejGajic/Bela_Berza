...
describe('PregledIsplata_uspesno', function() {
  this.timeout(30000)
  let driver
  let vars
  ...
  it('PregledIsplata_uspesno', async function() {
    ...
    assert(await driver.findElement(By.css(".wallet-out:nth-child(2)")).getText() == "Isplata")
  })
})
